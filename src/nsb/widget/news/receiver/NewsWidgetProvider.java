...
import nsb.widget.news.activity.ConfigurationActivity;
import nsb.widget.news.activity.ItemDetailsActivity;
import nsb.widget.news.data.dao.ConfigurationDao;
import nsb.widget.news.data.dao.DaoUtils;
import nsb.widget.news.fragments.item.ItemDetailsFragment;
import nsb.widget.news.model.Behaviour;
import nsb.widget.news.model.Configuration;
import nsb.widget.news.model.Mobilizer;
...
import nsb.widget.news.utils.StringUtils;
